...
export class StringArrayName extends AbstractName {
    ...
    constructor(source: string[], delimiter?: string) {
        super(delimiter);
        this.assertIsNotNullOrUndefined(source, "Source array");
    ...
    protected assertSetAllComponents(c: string[], backup: StringArrayName){
        ...
        MethodFailedException.assert(condition, "All components could not be properly set");
    }

    protected assertRemove(i : number, original: string, backup: StringArrayName){
        let condition: boolean = this.components[i] !== original;
        MethodFailedException.assert(condition, "Remove method did not properly function");
    }
